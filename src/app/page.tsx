...
const Home = () => {
  return (
    <Layout>
      ...
      <div className="min-h-screen flex flex-col justify-center p-10 md:pt-60 bg-gradient-to-r bg-white"> 
        <main className="flex flex-col text-center items-center justify-center">
          <div className="gradient z-0"></div>
          <h2 className="mx-8 mb-8 text-4xl font-bold text-main-color w-[1000px] h-auto leading-[54px] z-10">
          ...
          <p className="text-xl text-sub-color w-[1000px] h-auto leading-[26px] z-10">
